...
# Befor pushing check .gitignore file and make sure to not push node_module file and other importent file like .env, android & ios etc.
git rm -r --cached android ios <YOUR FOLDER NAME OR FILE NAME WITH EXTENSION>
git commit -m "Remove native files from tracking as per .gitignore"

# After pushing the impo file on git and now you want to add that folder to track
git add android ios
